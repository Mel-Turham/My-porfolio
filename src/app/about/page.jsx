				...
				<div className='p-4 sm:p-8 md:p-12 lg:p-20  flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2'>
					...
					<div className='flex flex-col gap-12 justify-center'>
						...
						<Image
							...
							width={115}
							height={115}
							className='w-[10rem] h-[10rem] rounded-full object-cover object-position-top'
						/>
						{/* BIOGRAPHY TITLE */}
						...
						<div className='text-base'>
							<p>
								I am <strong>mel turham</strong>, a third-year computer science
								student at <strong>The Cote University in cameroon</strong>,
								passionate about software development.
							</p>
							<p>
								Specializing in web and mobile development, I have gained
								expertise in &quot;JavaScript, React/Next.js,
								Python/Django&quot;, and I strive to create innovative digital
								solutions.
							</p>
							<p>
								My goal is to contribute effectively to large-scale projects
								while continuing to grow in this ever-evolving field.
							</p>
						</div>
						{/* BIOGRAPHY QUOTE */}
						<blockquote className='italic text-base text-gray-600'>
